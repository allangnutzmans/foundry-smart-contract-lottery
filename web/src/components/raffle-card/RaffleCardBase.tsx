...
const RoundCounter = ({ roundId }: { roundId: number }) => (
  <div className="absolute inset-0 flex items-center justify-center pointer-events-none -z-20">
    <div
      className="text-purple-200/50 font-semibold tracking-wider text-center ps-12 select-none"
      style={{ fontSize: 'clamp(1rem, 6vw, 8rem)' }}
    >
