...
export function ButtonGroup({ balance, symbol = 'ETH' }: { balance: string; symbol?: string }) {
  ...
  return (
    <ToggleGroup.Root
      type="single"
      className="flex flex-wrap sm:flex-nowrap w-full rounded-md bg-[#2b2d42]"
    ...
    >
      ...
      <ToggleGroup.Item
        value="wallet"
        className={cn(
          'flex-1 flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-white transition-colors',
