          ...
          <Collapsible defaultOpen={isChildActive}>
            <CollapsibleTrigger asChild>
              <SidebarMenuButton
                variant="outline"
                tooltip={item.title}
                isActive={isChildActive || pathname.startsWith(item.to || '/')}
              >
                {Icon && <Icon className="mr-2" />}
                <span>{item.title}</span>
        ...
        <SidebarFooter className="p-4 group-data-[collapsible=icon]:p-2">
          <div className="flex items-center justify-between mb-4 group-data-[collapsible=icon]:flex-col group-data-[collapsible=icon]:space-y-2">
            <Button variant="outline" size="icon" className="group-data-[collapsible=icon]:px-2">
              <a
                href="https://www.linkedin.com/in/allan-gnutzmans-5424191b5/"
                target="_blank"
            ...
            <Button variant="outline" size="icon" className="group-data-[collapsible=icon]:px-2">
              <a
                href="https://github.com/allangnutzmans/foundry-smart-contract-lottery"
                target="_blank"
                rel="noopener noreferrer"
              >
