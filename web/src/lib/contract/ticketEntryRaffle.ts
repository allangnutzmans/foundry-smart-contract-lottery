export const ticketEntryRaffle = {
  address: '0x7025ffF9F50cBd26d44104673A5220F6AB563488' as const,
  abi: [
    {
      inputs: [
    ...
    { inputs: [], name: 'Raffle__AlreadyEntered', type: 'error' },
    ...
    },
    {
      ...
      outputs: [
        {
          internalType: 'enum RaffleBase.RaffleState',
          name: '',
          type: 'uint8',
        },
      ],
